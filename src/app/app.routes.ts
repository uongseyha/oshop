...
export const routes: Routes = [
	...
	{ path: 'admin/products/new', canActivate: [authGuard], loadComponent: () => import('./admin/product-form/product-form').then(m => m.ProductForm) },
	{ path: 'admin/products/:id', canActivate: [authGuard], loadComponent: () => import('./admin/product-form/product-form').then(m => m.ProductForm) },
